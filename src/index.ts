...
async function main() {
  ...
  // let rive1 = await fetch(new Request("centaur.riv"));
  let rive2 = await fetch(new Request("obaK-centaur.riv"));
  console.log("pkp:  ~ file: index.ts:98 ~ main ~ rive2", rive2)
  let rive1 = await fetch(new Request("https://uploads.codesandbox.io/uploads/user/fe080a55-f514-4b57-b9ee-af30504ffa68/obaK-centaur.riv"));
  console.log("rive1 :: ", rive1);
  let arr1 = await rive1.arrayBuffer();
  console.log("arr1 :: ", arr1);

  let arr2 = await rive2.arrayBuffer();
  console.log("arr2 :: ", arr2);

  let fileBytes = new Uint8Array(arr1);
